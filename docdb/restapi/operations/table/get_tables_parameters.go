...
// GetTablesParams contains all the bound params for the get tables operation
...
//
// To ensure default values, the struct must have been initialized with NewGetTablesParams() beforehand.
func (o *GetTablesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTablesParams) bindKeyspaceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
