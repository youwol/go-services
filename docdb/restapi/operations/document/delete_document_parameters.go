...
// DeleteDocumentParams contains all the bound params for the delete document operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteDocument
type DeleteDocumentParams struct {

	// HTTP Request Object
	HTTPRequest *http.Request `json:"-"`

	/*Key of the documeent to delete
	  In: query
	*/
...
//
// To ensure default values, the struct must have been initialized with NewDeleteDocumentParams() beforehand.
func (o *DeleteDocumentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteDocumentParams) bindClusteringKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *DeleteDocumentParams) bindKeyspaceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteDocumentParams) bindOwner(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteDocumentParams()
		return nil
	}
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *DeleteDocumentParams) bindPartitionKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteDocumentParams) bindTableName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
